...
class distfit:
    ...
    def get_distributions(self, distr='full'):
        ...
        if isinstance(distr, list):
            ...
            out_distr = [st.alpha, st.anglit, st.arcsine, st.beta, st.betaprime, st.bradford, st.cauchy,
                         ...
                         st.rdist, st.reciprocal, st.rayleigh, st.rice, st.recipinvgauss, st.semicircular, st.skewcauchy, st.skewnorm, st.t,
